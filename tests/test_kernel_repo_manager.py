...
def test_get_file_content_file_not_found(temp_cache_dir):
    ...
    with pytest.raises(FileNotFoundError, match="File arch/x86/entry/syscalls/syscall_64.tbl not found in version v5.15"):
...
def test_get_syscall_files_post_2011():
    ...
    expected_calls = [
        (("v5.15:arch/x86/entry/syscalls/syscall_64.tbl",),),
        (("v5.15:include/linux/syscalls.h",),)
    ]
